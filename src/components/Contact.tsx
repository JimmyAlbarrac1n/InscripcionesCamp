        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-8">
          ...
          <div>
            ...
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-xs tracking-[0.3em] text-muted-foreground font-sans mb-2">TELÉFONO</h3>
                <a
              ...
              <div>
                ...
                <div className="space-y-1 font-sans text-foreground">
                  <div className="flex justify-between max-w-xs">
                    ...
                    <span className="text-muted-foreground">12:30 — 22:30</span>
                  </div>
                  <div className="flex justify-between max-w-xs">
                    <span>Sábado</span>
                    <span className="text-muted-foreground">12:30 — 22:30</span>
                  ...
                  <div className="flex justify-between max-w-xs">
                    <span>Domingo</span>
                    <span className="text-muted-foreground">12:00 — 17:00</span>
                  </div>
                  <div className="flex justify-between max-w-xs">
          ...
          <div className="relative">
            <div className="aspect-square md:aspect-auto md:h-full bg-secondary border border-border overflow-hidden relative">
              <iframe
                ...
                title="Ubicación En La Blanca - Quito"
