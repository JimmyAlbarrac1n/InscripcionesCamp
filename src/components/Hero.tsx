...
const Hero = () => {
  return (
    <section id="hero" className="relative min-h-screen flex items-end overflow-hidden bg-background">
      ...
      {/* Doodle rayones - pocos y sutiles */}
      <img src={doodle1} alt="" className="absolute top-[12%] left-[6%] w-20 md:w-28 pointer-events-none z-20 opacity-20" />
      <img src={doodle3} alt="" className="absolute bottom-[28%] right-[8%] w-24 md:w-32 pointer-events-none z-20 opacity-15" />
